...
Wire up a sun/moon icon button in the nav that toggles dark class on html; add dark: Tailwind variants throughout.
</todo>

<todo id="blog-page">
Build a full /blog listing page
A scrollable grid of all post cards with category filters (announcements, updates).
</todo>

<todo id="open-source-page">
Dedicated Open Source landing page
Deep-link each OSS tool with its own section, stats, and GitHub activity feed.
</todo>

<todo id="void-cta">
Add Void product CTA section
A distinct call-to-action block promoting Void Cloud with a sign-up / waitlist form.
</todo>

<todo id="perf-lazy-images">
Lazy-load images for performance
Add loading="lazy" to all below-fold images and use native intersection observer for deferred loads.
</todo>
